...
# Variables
aksClusterName="fabmedical-aiw"
aksResourceGroupName="fabmedical-aiw"
namespace="keda-dotnet-sample"
serviceAccountName="keda-operator"
applicationName="keda-fabmedical" 
...
if [[ -n $objectId ]]; then
  ...
  echo "Getting the ID of the AAD application with [$applicationName] display name..."
  objectId=$(az ad app show \
    --id $appId \
    --query id \
    --output tsv)
